	...
	while($language = $sqllanguageRes->fetch_object()){
		...
		echo 	"<tr>";
				echo 		"<td >Translated Name: </td>";
						echo 		"<td>";
						echo 			"<input class=\"changeArticleForm-title\"  type=\"text\" name=\"" . $language->Language_ID . "translatedName\" maxlength=\"45\" value=\"$translatedName\"  /input>";
						echo		"</td>";
						echo 	"</tr>";
						echo 	"<tr>";
						echo 		"<td >Translated Description: </td>";
		echo 		"<td>";
		echo 			"<textarea  class=\"changeArticleForm-description\" type=\"text\" name=\"" . $language->Language_ID . "translatedDescription\" >$translatedDescription</textarea>";
		echo		"</td>";
			echo 	"</tr>";
		}
